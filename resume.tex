...
\begin{minipage}[t]{0.6\textwidth}
    ...
    {\small ML Engineer \& Tech Lead $\cdot$ 13+ years in ML/AI systems}\\[3pt]
...
% AI/ML Initiatives - Multimodal Explainability → Agentic AI
\begin{projectentry}
    \projicon{\faBrain} \textbf{AI/ML Initiatives (In Progress)} \tech{PyTorch, CLIP, LangChain, Databricks} \approach{Multimodal Explainability $\rightarrow$ Agentic AI}
\end{projectentry}
...
\textbf{ML/AI} & PyTorch $\cdot$ TensorFlow $\cdot$ CLIP $\cdot$ LangChain $\cdot$ RAG $\cdot$ A/B Testing $\cdot$ Uncertainty Estimation $\cdot$ Monitoring \\
