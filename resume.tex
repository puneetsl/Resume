...
\begin{projectdesc}
    Drove CICD V4 migration and ML pipeline modernization with zero production incidents. Led alert reduction initiatives and bug triage coordination. Conduct technical interviews, mentor junior engineers, and lead code reviews across team.\\[1pt]
    \impact{\$500K annual savings, 61\% alert reduction (641$\rightarrow$249 alerts YoY)}
\end{projectdesc}
...
\textbf{Frameworks} & PyTorch/TensorFlow • PySpark • FastAPI • Metaflow • Databricks • MLflow • Django \\
\textbf{AI/ML} & CLIP Embeddings • LangChain • RAG • Feature Engineering • A/B Testing • Model Monitoring \\
\textbf{Infra} & Docker • Kubernetes • Terraform • GitLab CI • AWS • W\&B • Pinecone \\
\textbf{Leadership} & System Design • Technical Interviews • Mentoring • Code Reviews • Cross-team Coordination \\
\end{tabular}
\endgroup
...
\pie[
  ...
  every pin label/.style={font=\scriptsize}
]{20/Architecture, 10/MLOps, 15/Leadership, 15/Prompt Eng., 20/Coding, 10/Modeling, 10/Data Eng.}
\end{tikzpicture}
\end{center}
\end{minipage}%
\hfill
...
\begin{axis}[
    ...
    xmin=2010, xmax=2027,
    ymin=0, ymax=80,
    xtick={2011,2015,2019,2023,2026},
    ytick={0,20,40,60,80},
    yticklabel={\pgfmathprintnumber{\tick}\%},
    legend style={at={(0.5,-0.25)}, anchor=north, legend columns=3, font=\scriptsize, /tikz/every even column/.append style={column sep=3pt}},
    ymajorgrids=true,
    grid style=dashed,
...
\addplot[
    ...
    coordinates {
    (2011,75)(2013,67)(2015,60)(2017,53)(2019,45)(2021,40)(2023,34)(2025,40)(2026,35)
    };
...
\addplot[
    ...
    coordinates {
    (2011,20)(2013,27)(2015,33)(2017,40)(2019,45)(2021,48)(2023,45)(2025,40)(2026,40)
    };
...
\addplot[
    ...
    coordinates {
    (2011,5)(2013,6)(2015,7)(2017,7)(2019,10)(2021,12)(2023,21)(2025,20)(2026,25)
    };
\addlegendentry{Leadership}
