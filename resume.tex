...
\newcommand{\tinyfootnote}{\fontsize{8.5pt}{8.5pt}\selectfont} % Custom size between footnotesize and scriptsize
...
\begin{resumeentry}{Machine Learning Engineer}{Sep 2021 -- Present}{Zillow (Zestimate)}{Remote}{3Y}
\end{resumeentry}
