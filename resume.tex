...
\noindent\textbf{Languages} \hspace{2mm} Python • Java • C/C++ • Bash • SQL

\vspace{1pt}
\noindent\textbf{Frameworks} \hspace{0.5mm} PyTorch/TensorFlow • PySpark • FastAPI • Metaflow • Databricks • MLflow • Django

\vspace{1pt}
\noindent\textbf{AI/ML} \hspace{6.5mm} CLIP Embeddings • LangChain • RAG • Feature Engineering • A/B Testing • Model Monitoring

\vspace{1pt}
\noindent\textbf{Infra} \hspace{10mm} Docker • Kubernetes • Terraform • GitLab CI • AWS • W\&B • Pinecone

\vspace{1pt}
\noindent\textbf{Leadership} \hspace{4mm} System Design • Technical Interviews • Mentoring • Code Reviews • Cross-team Coordination
...
\textbf{\iconlink{\faUsers}{https://sites.google.com/view/w-mufin/organizers}{Workshop Organizer @ MUFin}} & Program committee member, paper reviewer at top ML conferences -- Workshop on Modeling Uncertainty in the Financial Sector \textit{(AAAI 2023, ECML-PKDD 2022)} \\[3pt]
